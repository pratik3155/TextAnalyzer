...
export default function Tick({ mode, title, ShowAlert }) {
  ...
  const translateText = async () => {
    ...
    try {
      ...
      const translatedResults = response.data[0].translations.map(
      ...
      <div className="row">
        <div className="col-md-6">
          ...
          <div className="d-grid gap-2">
            ...
            <button className="btn btn-primary" onClick={toreverse}>
              Reverse Text
            </button>
            <button className="btn btn-info" onClick={onSaveText}>
              Save Text
            </button>
        ...
        <div className="col-md-6">
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <button className="btn btn-warning" onClick={translateText}>
              Translate
            </button>
          </div>
          {translatedText && (
